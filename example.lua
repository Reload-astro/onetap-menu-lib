...
local legit = window:tab({name = 'aimbot'})
local rage = window:tab({name = 'antiaim'})
local esp = window:tab({name = 'movement'})
...
do
    ...
    section:slider({
        ...
        max = 100,
        interval = 0.5,
        callback = function(num) print(num) end
    })
    section:toggle({
...
do
    ...
    local esp_settings = esp:section({
        name = 'esp_settings',
        fill = 0.1,
        side = 'right'
    })
    ...
    enemy:toggle({
        name = 'health bar',
        flag = 'enemy_healthbar',
        default = false,
        tooltip = 'shows enemy health bars'
    })
    enemy:colorpicker({
        object = 'health bar',
        flag = 'enemy_lowhealth',
        color = Color3.fromRGB(255, 100, 100)
    })
    enemy:colorpicker({
        object = 'health bar',
        flag = 'enemy_fullhealth',
    ...
    enemy:toggle({
        ...
        flag = 'enemy_name',
        default = false,
        tooltip = 'shows enemy names'
    })
    enemy:colorpicker({
        object = 'display name',
        flag = 'enemy_namecolor',
        color = Color3.new(1, 1, 1)
    })
    ...
    enemy:toggle({
        ...
        flag = 'enemy_rank',
        default = false,
        tooltip = 'shows enemy ranks'
    })
    enemy:colorpicker({
        object = 'rank',
        flag = 'enemy_rankcolor',
        color = Color3.fromRGB(0, 219, 255)
    })
    ...
    enemy:toggle({
        ...
        flag = 'enemy_stance',
        default = false,
        tooltip = 'shows what stance a enemy has'
    })
    enemy:colorpicker({
        object = 'stance',
        flag = 'enemy_stancecolor',
        color = Color3.new(1, 1, 1)
    })
    ...
    enemy:toggle({
        ...
        flag = 'enemy_visible',
        default = false,
        tooltip = 'shows if a enemy is visible'
    })
    enemy:colorpicker({
        object = 'visible',
        flag = 'enemy_visiblecolor',
        color = Color3.new(1, 1, 1)
    })
    ...
    enemy:toggle({
        ...
        flag = 'enemy_skeleton',
        default = false,
        tooltip = 'shows enemy skeletons'
    })
    enemy:colorpicker({
        object = 'skeleton',
        flag = 'enemy_skeletoncolor',
        color = Color3.fromRGB(236, 251, 136)
    })

    enemy:toggle({
        name = 'snap lines',
        flag = 'enemy_snaplines',
        default = false,
        tooltip = 'shows enemy snap lines'
    })
    enemy:colorpicker({
        object = 'snap lines',
    ...
    dropped:toggle({
        name = 'weapon names',
        flag = 'dropped_weaponnames',
        default = false,
        tooltip = 'shows weapon names'
    }):colorpicker({
        object = 'weapon names',
        name = 'weapon name',
    ...
    team:toggle({
        ...
        flag = 'team_healthbar',
        default = false,
        tooltip = 'shows team health bars'
    }):colorpicker({
        object = 'health bar',
        name = 'low health',
        flag = 'team_lowhealth',
    ...
    team:toggle({
        ...
        flag = 'team_stance',
        default = false,
        tooltip = 'shows what stance a teammate has'
    }):colorpicker({
        object = 'stance',
        name = 'stance flag',
        flag = 'team_stance',
    ...
    team:toggle({
        ...
        flag = 'team_visible',
        default = false,
        tooltip = 'shows if a teammate is visible'
    }):colorpicker({
        object = 'visible',
        name = 'visible flag',
    ...
    team:toggle({
        ...
        flag = 'team_skeleton',
        default = false,
        tooltip = 'shows teammate skeletons'
    }):colorpicker({
        object = 'skeleton',
        name = 'skeleton',
...
do -- Visuals
    ...
    world:toggle({name = 'local bullet tracers'}):colorpicker({
        color = Color3.fromHex('#C94536'),
        alpha = 1
    })
    world:toggle({name = 'enemy bullet tracers'}):colorpicker({
        color = Color3.fromHex('#C94536'),
        alpha = 1
    })
    world:slider({
    ...
    world:dropdown({
        ...
        items = {'dimmed', 'bright', 'default'},
        default = 'dimmed'
    })
    world:toggle({name = 'teleporting lines'}):colorpicker({
        color = Color3.fromRGB(168, 232, 65),
        alpha = 1
    })
...
for i = 1, 100 do library:notification({text = 'This is a text notification!'}) end
